...
**Package:** `geniustechspace.idp.authn.mfa.events.v1`

## Overview

Domain events for mfa lifecycle changes in authentication workflows.
...
Events published for mfa creation, validation, expiration, and revocation actions.
