...
Domain entities and enums for credential management in authentication workflows.

## Purpose

- Define credential entity structure for authentication
...
Primary entity for credential management. Contains tenant_id, user_id, status, and domain-specific security attributes.
