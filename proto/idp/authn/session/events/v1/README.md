...
**Package:** `geniustechspace.idp.authn.session.events.v1`

## Overview

Domain events for session lifecycle changes in authentication workflows.
...
Events published for session creation, validation, expiration, and revocation actions.
