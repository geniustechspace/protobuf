...
**Package:** `geniustechspace.idp.authz.permission.events.v1`

## Overview

Domain events for permission lifecycle changes in authorization workflows.
...
Events published for permission creation, updates, assignments, and removals.
