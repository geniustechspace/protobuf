...
**Package:** `geniustechspace.idp.authz.policy.events.v1`

## Overview

Domain events for policy lifecycle changes in authorization workflows.
...
Events published for policy creation, updates, assignments, and removals.
