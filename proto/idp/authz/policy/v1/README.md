...
Domain entities and enums for policy-based authorization controls.

## Purpose

- Define policy entity structure for access control
...
Primary entity for policy management. Supports hierarchical structures and dynamic evaluation.
